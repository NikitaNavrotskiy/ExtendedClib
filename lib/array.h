...
#define ARRAY_CAPACITY_INCREASE_FACTOR 1.5
 ...
 * elements (ALL INCLUDED). <last> == NULL, means
 * from <first> to the end of array including.
 * <first> == NULL, just returns NULL, doing nothing. 
 * 
 * @param arr Pointer to array instance.
